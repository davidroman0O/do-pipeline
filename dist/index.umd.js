(function (global, factory) {
	...
	(global['do-pipeline'] = factory(global.Promise$1));
}(this, (function (Promise$1) { 'use strict';
	...
	var Pipeline = /*#__PURE__*/
	(function () {
	  var _ref = asyncToGenerator(
	  /*#__PURE__*/
	  regenerator.mark(function _callee(a) {
	    return regenerator.wrap(function _callee$(_context) {
	      while (1) {
	        switch (_context.prev = _context.next) {
	          case 0:
	            _context.next = 2;
	            return Promise$1.reduce(a.slice(1, a.length), function (ac, cv) {
	              return cv(ac);
	            }, a[0]);
